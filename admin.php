  ...
  <div class="login-page">
    <div class="form" style="background-color:transparent; height:400px; margin-top:22px;">
      <form class="login-form" method="post" action="admin.php">
        ...
        <input type="submit" name="btn" value="Login" id="cls" class="text-center mt-3 rounded" style="background-color:rgba(46, 110, 230, 0.801); color:white;">
      </form>
    </div>
  </div>
  <script>
...
<?php
  ...
  function user_login1($u, $p)
  {
    ...
    if ($num == 1) {
      echo 'login';
      echo '<script>window.location.href="bankadmin.php";alert("successfully login");</script>';
