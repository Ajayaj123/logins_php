...
<body class="Signin" style="background-image: url(./img/signup-bg.webp)!important; background-position:center !important; background-repeat: no-repeat !important; background-size: cover !important; height: 100vh;" >
  <div class="login-page">
    <div class="form"  style="height: 410px; background-color:transparent; margin: 30px 6px; width: 80%;">
      <form class="login-form" method="post" action="register.php" >
        ...
        <h2 class="log" style="color:rgba(255, 255, 255, 0.896) ; margin-top:7px;  font-size: 2.6rem;"> SIGN UP</h2>
            ...
            <input type="email" placeholder="Email" name="email" required style="margin:30px 0 0 0 ;background-color:rgba(240, 248, 255, 0.883); font-size: 1rem; padding-left: 8px;  border-radius: 5px;"/>
            
            <input type="password" placeholder="Password" name="pass" style="margin:30px 0 0 0 ;background-color:rgba(240, 248, 255, 0.883); font-size: 1rem; padding-left: 8px;  border-radius: 5px;"/>

            <input type="submit" name="btn" value="Sign Up" id="cls" style="margin:30px 0 5px 0 ; font-size: 1.2rem; background-color: rgba(0, 111, 202, 0.709);">
