...
<body class="log" style="background-image: url(./img/loanbg.jpg) !important; background-position: bottom !important; background-repeat: no-repeat !important; background-size: cover !important; height: 100vh;" >
    <div class="login-page">
        <div class="form " style="height: 400px; background-color:transparent; margin: 40px 6px; width: 73%;">
          <form class="login-form" method="post" action="login.php" >
            ...
            <input type="submit" name="btn" value="Login" id="cls" class="logout" style="margin:35px 0 30px 0 ; font-size: 1.2rem; background-color: rgba(0, 111, 202, 0.709);">
...
function user_login($e,$p)
{
   ...
   if($num==1)
   {
     ...
     echo '<script>window.location.href="index.html";alert("successfully login");</script>';
